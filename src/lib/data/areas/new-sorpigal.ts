...
export const newSorpigal: Area = {
  ...
  <li>Inn (A Lonely Knight)
    <ol>
      ...
      <li>Sheila Loompus (upstairs)
        <ul>
          <li>Expert identification (rank 4, 500 gp)</li>
        </ul>
      </li>
      <li>Tara D'Cathay (upstairs)
        <ul>
          <li>Expert perception (rank 4, 500 gp)</li>
        </ul>
      </li>
    </ol>
  </li>
  <li>Well, 100 gp if 0 in purse (once per week)</li>
  <li>Dragon tower</li>
  <li>Hejaz Mawsil
    <ul>
      <li>Buys cobra eggs for 1000 gp each</li>
      <li>Buccaneers' Lair membership (25 gp)</li>
    </ul>
  </li>
  <li>Harold Hess
    <ul>
      <li>Blades' End membership (25 gp)</li>
    </ul>
  </li>
  ...
  <li>Enk Salzburg
    <ul>
      <li>Expert body building (rank 4, 500 gp)</li>
    </ul>
  </li>
  <li>Victor Hose
    <ul>
      <li>Expert meditation (rank 4, 500 gp)</li>
    </ul>
  </li>
  <li>Violet Dawson
    <ul>
      <li>Angela</li>
      <li>Guild of the Self membership (100 gp)</li>
    </ul>
  </li>
  <li>Buford T. Allman
    <ul>
      <li>Spider Queen (Quest, Spider Queen Heart)</li>
      <li>Elemental Guild membership (100 gp)</li>
    </ul>
  </li>
  ...
  <li>Isao Magistrus
    <ul>
      <li>Expert fire magic (rank 4, 1000 gp)</li>
    </ul>
  </li>
  <li>Taro
    <ul>
      <li>Expert earth magic (rank 4, 1000 gp)</li>
    </ul>
  </li>
  <li>Training hall, max level 15 (New Sorpigal Training Grounds)</li>
  <li>Enoch Highridge
    <ul>
      <li>Expert spirit magic (rank 4, 1000 gp)</li>
    </ul>
  </li>
  <li>Virgil Holiday
    <ul>
      <li>Expert mind magic (rank 4, 1000 gp)</li>
    </ul>
  </li>
  <li>Abdulai Mahgreb
    <ul>
      <li>Expert body magic (rank 4, 1000 gp)</li>
    </ul>
  </li>
  ...
  <li>Bank, Cheryl Duncan (upstairs )
    <ul>
      <li>Expert air magic (rank 4, 1000 gp)</li>
    </ul>
  </li>
  <li>Town hall
    <ol>
  ...
  <li>Initiate Guild of the Self, Donald Retzer (upstairs )
    <ul>
      <li>Expert learning (rank 4, 2000 gp)</li>
    </ul>
  </li>
  ...
  <li>Dorf
    <ul>
      <li>Expert staff (rank 4, 2000 gp)</li>
    </ul>
  </li>
  <li>Falagar</li>
  <li>Docks</li>
  ...
  <li>Douglas Hill
    <ul>
      <li>Expert water magic (rank 4, 1000 gp)</li>
    </ul>
  </li>
  <li>Igor
    <ul>
      <li>Expert blaster (rank 4, 2000 gp)</li>
    </ul>
  </li>
