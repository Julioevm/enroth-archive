...
export const dungeons: Dungeon[] = [
  {
    ...
    description:
      'A fortified outpost overrun by goblins. The air is thick with the smell of filth and stale meat.',
  ...
  },
  {
    ...
    areaSlug: 'free-haven',
    mapImageUrl:
      'https://images.unsplash.com/photo-1625239622428-ba0ae330a1f9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwzfHxoaWRlb3V0JTIwbWFwfGVufDB8fHx8MTc2NTk2NzkzMnww&ixlib=rb-4.1.0&q=80&w=1080',
    mapImageDescription: 'Map of Shadow Guild Hideout',
    description:
      "A hidden network of cellars and tunnels beneath Free Haven, serving as the local thieves' guild headquarters.",
  ...
  },
  {
    ...
    areaSlug: 'mist',
    mapImageUrl:
      'https://images.unsplash.com/photo-1662307414188-334c0b5713e6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw5fHxldmlsJTIwdGVtcGxlfGVufDB8fHx8MTc2NTk2NzkzMnww&ixlib=rb-4.1.0&q=80&w=1080',
    mapImageDescription: 'Map of Temple of Baa',
    description:
      'A major center of Baa worship on the island of MIST. The temple is heavily guarded.',
