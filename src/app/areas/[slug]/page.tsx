            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="font-semibold flex items-center gap-2 mb-2">
                  <LandPlot className="w-4 h-4 text-muted-foreground" /> By Foot
                </h3>
              ...
              {(area.travel.coach.length > 0 ||
                area.travel.boat.length > 0) && <Separator />}

              {area.travel.coach.length > 0 && (
                <div>
                  <h3 className="font-semibold flex items-center gap-2 mb-2">
                    <Bus className="w-4 h-4 text-muted-foreground" /> Coach
                  </h3>
              ...
              {area.travel.boat.length > 0 && (
                <div>
                  <h3 className="font-semibold flex items-center gap-2 mb-2">
                    <Sailboat className="w-4 h-4 text-muted-foreground" /> Boat
                  </h3>
                  <ul className="space-y-1 text-muted-foreground">
